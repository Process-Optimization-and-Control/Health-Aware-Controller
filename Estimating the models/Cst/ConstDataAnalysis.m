...
% saving normalization NN
regrCenter_NN = mean(NormTestData,1)';
regrScale_NN = std(NormTestData,[],1)';

predCenter_NN = mean(NormTestResponse,1)';
predScale_NN = std(NormTestResponse,[],1)';

nameSave = 'normalizationValues_NN';
save(nameSave,'regrCenter_NN','regrScale_NN','predCenter_NN','predScale_NN')
