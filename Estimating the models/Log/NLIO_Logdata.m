...
% Created 23-Nov-2020 20:43:13
%
% This script assumes these variables are defined:
%
%   NNRegData - input time series.
%   NNRegResponse - target time series.

X = tonndata(NNRegData,false,false);
T = tonndata(NNRegResponse,false,false);
...
if (true)
    ...
    genFunction(net,'NLIOnet','MatrixOnly','yes');
    x1 = cell2mat(x(1,:));
    xi1 = cell2mat(xi(1,:));
    y = NLIOnet(x1,xi1);
end
